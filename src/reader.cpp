...
namespace gsj
{
    ...
    void Reader ::Read_Envs_from_file(const std::string file_path, std::list<geos::geom::Envelope *> *list_envs)
    {
        std::vector<std::string> *vect_strs = new std::vector<std::string>;
        ...
        Read_Envs_from_strs(vect_strs, list_envs);

        vect_strs->clear();
        vect_strs->shrink_to_fit();
    }

    void Reader ::Read_Envs_from_strs(std::vector<std::string> *vect_strs, std::list<geos::geom::Envelope *> *list_envs)
    {
